...
if __name__ == '__main__':
    ...
    ref = np.array(cv2.imread(r'Objective_testing//Objective_testing_before.jpg',0).tolist())
    raw = np.array(cv2.imread(r'Objective_testing//Objective_testing_after.jpg',0).tolist())
