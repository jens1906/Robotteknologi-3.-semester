...
if __name__ == "__main__":
    ...
    ref = np.array(Image.open('.Objective_testing\Objective_testing_before.jpg').convert('LA'))[:,:,0] # ref
    dis = np.array(Image.open('.Objective_testing\Objective_testing_after.jpg').convert('LA'))[:,:,0] # dis
